      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-0.5 text-xs text-muted-foreground">
            {/*
              Хендл вставляется, только если он есть. Пустая строка приходит из
              анон-чата в реальном режиме, когда `/roulette/status` ещё не
              ответил (перезагрузка страницы в чате): дефолт параметра на неё не
              срабатывает — он только для `undefined`, — и текст выходил с
              дырой: «Собеседник  предлагает раскрыть профили». Подставлять
              вместо неизвестного хендла демонстрационный «~SAMPLE» тем более
              нельзя: это выдуманный собеседник на живом экране.
            */}
            {partnerId
