  ...
  render() {
    ...
    return (
      <div className="scrollable-panel">
        ...
        <div className="hr" />
        <div className="panel-form-column">
          <div className="anoon-segmented">
            <a href="#" className="anoon-seg-item" onClick={e => {e.preventDefault(); this.props.onNavigate('acc_general');}}>
            ...
            <a href="#" className="anoon-seg-item" onClick={e => {e.preventDefault(); this.props.onNavigate('notif');}}>
            ...
            <a href="#" className="anoon-seg-item" onClick={e => {e.preventDefault(); this.props.onNavigate('security');}}>
            ...
            <a href="#" className="anoon-seg-item" onClick={e => {e.preventDefault(); this.props.onNavigate('support');}}>
          ...
          <a href="#" className="anoon-logout" onClick={e => {e.preventDefault(); this.props.onLogout();}}>
