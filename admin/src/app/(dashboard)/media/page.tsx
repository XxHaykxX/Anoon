    ...
    <div>
      ...
      {err ? (
        ...
        <div className="grid gap-4 lg:grid-cols-[minmax(0,320px)_minmax(0,1fr)]">
          {/* Папки. На мобиле (как в Чаты) прячутся, когда открыта галерея папки. */}
          ...
          {/* Галерея. На мобиле видна только после выбора папки, со стрелкой «назад». */}
          <div className={cn("rounded-xl border border-border bg-surface-1 p-5", !sel && "hidden lg:block")}>
            {!sel ? (
              <div className="py-16 text-center text-fg-muted">Выбери папку</div>
            ) : (
              <>
