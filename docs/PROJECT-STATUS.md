...
> **СВЕЖЕЕ (2026-08-05) — читать первым:**
> - [SESSION-2026-08-05.md](SESSION-2026-08-05.md) — объединение трёх папок в одну,
>   переименование, ~15 починенных багов, **и раздел «Что осталось»**.
> - [SECURITY-FINDINGS.md](SECURITY-FINDINGS.md) — **2 находки высокого уровня,
>   не починены**: `/auth/rest` без авторизации позволяет навсегда лишить
>   человека входа; анонимная рулетка выдаёт настоящий `#ID` до раскрытия.
>   Закрыть до запуска.
>
